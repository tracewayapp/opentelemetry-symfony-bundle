...
open_telemetry:
    ...
    sdk:
        ...
        resource_attributes: []               # Merged/replaced key and value pairs with existing OTEL_RESOURCE_ATTRIBUTES variable. It defaults to an empty array.
        exporter_otlp_headers: []             # Merged/replaced key and value pairs with existing OTEL_EXPORTER_OTLP_HEADERS variable. It defaults to an empty array.
```
